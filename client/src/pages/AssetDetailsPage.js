              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  <div className="flex flex-col items-center gap-2 text-indigo-600">
                    ...
                    <span className="text-xs text-indigo-400">Take Photo</span>
                  </div>
                </button>
              ...
              <div className="col-span-12 lg:col-span-4 space-y-2">
                ...
                <div className="bg-white rounded-lg shadow border border-gray-200 overflow-hidden p-2">
                  <div className="flex gap-2">
                    ...
                    {displayImages.length >= 1 && (
                      <div className="flex flex-col gap-2 w-16">
                        ...
                        {displayImages.length > 3 && (
                          ...
                          >
                            <span className="text-xs font-bold text-gray-600 hover:text-indigo-600">
                              +{displayImages.length - 3}
                            </span>
                          </button>
                        )}
                    ...
                    >
                      ...
                      <div className="absolute inset-0 bg-black/0 group-hover:bg-black/10 transition-all flex items-center justify-center opacity-0 group-hover:opacity-100">
                        <span className="bg-black/50 text-white px-3 py-1.5 rounded-full text-xs font-medium">
                          Click to zoom
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="mt-2 pt-2 border-t border-gray-100">
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 py-2 px-3 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 rounded-lg text-sm font-medium transition-all"
                    >
                ...
                <div className="bg-yellow-50 rounded-lg border border-yellow-200 p-2">
                  <div className="flex items-center gap-1 mb-2">
                    ...
                    <p className="text-xs font-bold text-yellow-800">Recent Changes (変更履歴)</p>
                    ...
                    {changeHistory.length === 0 ? (
                      <>
                        <div className="bg-white rounded p-1.5 border border-yellow-100 opacity-60">
                          ...
                          <p className="text-[10px] text-gray-500 italic">Changes will appear here after edits</p>
                        </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-white rounded-lg shadow border border-gray-200 p-3">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <h3 className="text-sm font-bold text-gray-900">基本情報 (Primary Information)</h3>
                    </div>
                    <div className="grid grid-cols-2 gap-2">
                      {/* 資産番号 */}
                      <div className="bg-indigo-50 rounded p-2 border border-indigo-200">
                        <p className="text-[10px] font-bold text-indigo-700 mb-0.5">資産番号 (Asset Number)</p>
                        <div className="flex items-center justify-between gap-2">
                          <p className="text-xs font-semibold text-gray-900 font-mono truncate">{asset.id || ''}</p>
                          <button
                            type="button"
                      ...
                      <div className="bg-orange-50 rounded p-2 border border-orange-200">
                        <p className="text-[10px] font-bold text-orange-700 mb-0.5">管理箇所 (Management Location)</p>
                        {isEditing ? (
                          <input
                            type="text"
                            value={editedAsset.management_location || ""}
                            onChange={(e) => setEditedAsset({ ...editedAsset, management_location: e.target.value })}
                            className="w-full text-xs font-semibold border border-gray-300 rounded px-1 py-0.5"
                          />
                        ) : (
                          <p className="text-xs font-semibold text-gray-900">{asset.management_location || ''}</p>
                        )}
                      </div>

                      {/* 品名 */}
                      <div className="bg-green-50 rounded p-2 border border-green-200">
                        <p className="text-[10px] font-bold text-green-700 mb-0.5">品名 (Product Name)</p>
                        {isEditing ? (
                          <input
                            type="text"
                      ...
                      <div className="bg-purple-50 rounded p-2 border border-purple-200">
                        <p className="text-[10px] font-bold text-purple-700 mb-0.5">使用者名（和光）(User Name - Wako)</p>
                        {isEditing ? (
                          <input
                            type="text"
                          ...
                          <p className="text-xs font-semibold text-gray-900">{asset.user || ''}</p>
                        )}
                      </div>

                      {/* 建屋 */}
                      <div className="bg-blue-50 rounded p-2 border border-blue-200">
                        <p className="text-[10px] font-bold text-blue-700 mb-0.5">建屋 (Building)</p>
                        {isEditing ? (
                          <input
                            type="text"
                          ...
                          <p className="text-xs font-semibold text-gray-900">{asset.building || ''}</p>
                        )}
                      </div>

                      {/* 設置場所 */}
                      <div className="bg-cyan-50 rounded p-2 border border-cyan-200">
                        <p className="text-[10px] font-bold text-cyan-700 mb-0.5">設置場所 (Installation Location)</p>
                        {isEditing ? (
                          <input
                            type="text"
                          ...
                          <p className="text-xs font-semibold text-gray-900">{asset.installation_location || ''}</p>
                        )}
                      </div>

                      {/* 詳細場所 */}
                      <div className="bg-teal-50 rounded p-2 border border-teal-200">
                        <p className="text-[10px] font-bold text-teal-700 mb-0.5">詳細場所 (Detailed Location)</p>
                        {isEditing ? (
                          <input
                            type="text"
                          ...
                          <p className="text-xs font-semibold text-gray-900">{asset.room || ''}</p>
                        )}
                      </div>

                      {/* 設置状況 */}
                      <div className="bg-pink-50 rounded p-2 border border-pink-200">
                        <p className="text-[10px] font-bold text-pink-700 mb-0.5">設置状況 (Installation Status)</p>
                        {isEditing ? (
                          <input
                            type="text"
                          ...
                          <p className="text-xs font-semibold text-gray-900">{asset.status || ''}</p>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="mt-2 bg-indigo-50 rounded p-2 border border-indigo-200">
                      <p className="text-[10px] font-bold text-indigo-700 mb-1">QR コード (QR Code)</p>
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex-1">
                          <p className="text-[10px] text-gray-600 mb-0.5">Scan to view asset</p>
                  ...
                  <div className="bg-white rounded-lg shadow border border-gray-200 p-3">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <h3 className="text-sm font-bold text-gray-900">今年度データ (Current Year Data)</h3>
                    </div>
                    <div className="grid grid-cols-2 gap-2">
                      {/* 建屋 */}
                      <div className="bg-green-50 rounded p-2 border border-green-200">
                        <p className="text-[10px] font-bold text-green-700 mb-0.5">建屋 (Building)</p>
                        {isEditing ? (
                          <input
                            type="text"
                            value={editedAsset.building || ""}
                      ...
                      {/* 設置場所 */}
                      <div className="bg-green-50 rounded p-2 border border-green-200">
                        <p className="text-[10px] font-bold text-green-700 mb-0.5">設置場所 (Installation Location)</p>
                        {isEditing ? (
                          <input
                            type="text"
                            value={editedAsset.installation_location || ""}
                      ...
                      {/* 詳細場所 */}
                      <div className="bg-green-50 rounded p-2 border border-green-200">
                        <p className="text-[10px] font-bold text-green-700 mb-0.5">詳細場所 (Detailed Location)</p>
                        {isEditing ? (
                          <input
                            type="text"
                            value={editedAsset.room || ""}
                      ...
                      {/* 設置状況 */}
                      <div className="bg-green-50 rounded p-2 border border-green-200">
                        <p className="text-[10px] font-bold text-green-700 mb-0.5">設置状況 (Installation Status)</p>
                        {isEditing ? (
                          <input
                            type="text"
                            value={editedAsset.status || ""}
                    ...
                    <div className="mt-2 bg-green-50 rounded p-2 border border-green-200">
                      <p className="text-[10px] font-bold text-green-700 mb-0.5">コメント (Comment)</p>
                      {isEditing ? (
                        <textarea
                          value={editedAsset.notes || ""}
                          onChange={(e) => setEditedAsset({ ...editedAsset, notes: e.target.value })}
                          rows={2}
                          className="w-full text-xs border border-gray-300 rounded px-2 py-1 focus:ring-2 focus:ring-green-500 resize-none"
                        />
                      ) : (
                        <p className="text-xs text-gray-700">{asset.notes || ''}</p>
                      )}
                    </div>

                    {/* 資産ラベル再発行 */}
                    <div className="mt-2 bg-green-50 rounded p-2 border border-green-200">
                      <p className="text-[10px] font-bold text-green-700 mb-0.5">資産ラベル再発行 (Asset Label Reissue)</p>
                      {isEditing ? (
                        <input
                          type="text"
                        ...
                        <p className="text-xs font-semibold text-gray-900">{asset.label_reissue || ''}</p>
                      )}
                    </div>

                    {/* 再発行理由 */}
                    <div className="mt-2 bg-green-50 rounded p-2 border border-green-200">
                      <p className="text-[10px] font-bold text-green-700 mb-0.5">再発行理由 (Reissue Reason)</p>
                      {isEditing ? (
                        <textarea
                        ...
                        <p className="text-xs text-gray-700">{asset.reissue_reason || ''}</p>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg shadow border border-gray-200 p-3">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      <div className="bg-amber-50 rounded p-2 border border-amber-200">
                        <p className="text-[10px] font-bold text-amber-700 mb-0.5">【昨年】調查者 (Last Year Investigator)</p>
                        {isEditing ? (
                          <input
                            type="text"
                          ...
                          <p className="text-xs font-semibold text-gray-900">{asset.last_year_investigator || ''}</p>
                        )}
                      </div>

                      {/* 【昨年】建屋 */}
                      <div className="bg-amber-50 rounded p-2 border border-amber-200">
                        <p className="text-[10px] font-bold text-amber-700 mb-0.5">【昨年】建屋 (Last Year Building)</p>
                        {isEditing ? (
                          <input
                            type="text"
                          ...
                          <p className="text-xs font-semibold text-gray-900">{asset.last_year_building || ''}</p>
                        )}
                      </div>

                      {/* 【昨年】設置場所 */}
                      <div className="bg-amber-50 rounded p-2 border border-amber-200">
                        <p className="text-[10px] font-bold text-amber-700 mb-0.5">【昨年】設置場所 (Last Year Installation Location)</p>
                        {isEditing ? (
                          <input
                            type="text"
                          ...
                          <p className="text-xs font-semibold text-gray-900">{asset.last_year_installation_location || ''}</p>
                        )}
                      </div>

                      {/* 【昨年】詳細場所 */}
                      <div className="bg-amber-50 rounded p-2 border border-amber-200">
                        <p className="text-[10px] font-bold text-amber-700 mb-0.5">【昨年】詳細場所 (Last Year Detailed Location)</p>
                        {isEditing ? (
                          <input
                            type="text"
                          ...
                          <p className="text-xs font-semibold text-gray-900">{asset.last_year_detailed_location || ''}</p>
                        )}
                      </div>

                      {/* 【昨年】設置状況 */}
                      <div className="bg-amber-50 rounded p-2 border border-amber-200">
                        <p className="text-[10px] font-bold text-amber-700 mb-0.5">【昨年】設置状況 (Last Year Installation Status)</p>
                        {isEditing ? (
                          <input
                            type="text"
                          ...
                          <p className="text-xs font-semibold text-gray-900">{asset.last_year_installation_status || ''}</p>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="mt-2 bg-amber-50 rounded p-2 border border-amber-200">
                      <p className="text-[10px] font-bold text-amber-700 mb-0.5">【昨年】コメント (Last Year Comment)</p>
                      {isEditing ? (
                        <textarea
                          value={editedAsset.last_year_comment || ""}
                          onChange={(e) => setEditedAsset({ ...editedAsset, last_year_comment: e.target.value })}
                          rows={2}
                          className="w-full text-xs border border-gray-300 rounded px-2 py-1 focus:ring-2 focus:ring-amber-500 resize-none"
                        />
                      ) : (
                        <p className="text-xs text-gray-700">{asset.last_year_comment || ''}</p>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg shadow border border-gray-200 p-3">
                    ...
                    <div className="bg-slate-50 rounded p-2 border border-slate-200 mb-2">
                      <p className="text-[10px] font-bold text-slate-700 mb-0.5">備考（設置場所）(Remarks - Installation Location)</p>
                      {isEditing ? (
                        <textarea
                          ...
                          rows={2}
                          className="w-full text-xs border border-gray-300 rounded px-2 py-1 focus:ring-2 focus:ring-slate-500 resize-none"
                        />
                      ) : (
                        <p className="text-xs text-gray-700">{asset.remarks_installation_location || ''}</p>
                      )}
                    </div>

                    {/* 備考（修理/貸出等） */}
                    <div className="bg-slate-50 rounded p-2 border border-slate-200">
                      <p className="text-[10px] font-bold text-slate-700 mb-0.5">備考（修理/貸出等）(Remarks - Repair/Loan etc.)</p>
                      {isEditing ? (
                        <textarea
                        ...
                        <p className="text-xs text-gray-700">{asset.remarks_repair_loan || ''}</p>
                      )}
                    </div>
                  </div>
