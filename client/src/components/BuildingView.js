...
function AssetCard({ asset, onClick }) {
  return (
    ...
    >
      ...
      <div className="p-2">
        <h4 className="font-bold text-gray-900 text-xs mb-0.5 truncate">{asset.name}</h4>
        <p className="text-[9px] text-gray-500 font-mono mb-1 truncate">ID: {String(asset.id)}</p>
    ...
    >
      ...
      <div className="flex-1 min-w-0 flex items-center gap-3">
        <div className="min-w-0 flex-1">
          <h4 className="font-semibold text-gray-900 text-xs truncate">{asset.name}</h4>
          <p className="text-[9px] text-gray-500 font-mono truncate">ID: {String(asset.id)}</p>
        </div>
    ...
    >
      ...
      >
        ...
        <div className="bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-600 px-4 py-2 md:px-5 md:py-3 flex items-center justify-between rounded-t-2xl flex-shrink-0">
          <h3 className="text-base md:text-lg font-bold text-white">Asset Information</h3>
        ...
        <div className="flex-1 overflow-y-auto p-3 md:p-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 md:gap-3">
            ...
            <div className="flex flex-col gap-1.5 md:gap-2">
              ...
              <div className="bg-indigo-50 rounded-lg p-1.5 md:p-2 border border-indigo-200">
                <div className="flex items-center gap-1 mb-0.5">
                  <Barcode className="w-3 h-3 text-indigo-600" />
                  <p className="text-[9px] md:text-[10px] font-bold text-indigo-700 uppercase tracking-wide">資産番号 (Asset Number)</p>
                </div>
                <div className="flex items-center justify-between gap-2">
                  <p className="text-xs md:text-sm font-bold text-gray-900 font-mono truncate">{asset.id}</p>
                  <button
                    type="button"
              ...
              <div className="bg-orange-50 rounded-lg p-1.5 md:p-2 border border-orange-200">
                <div className="flex items-center gap-1 mb-0.5">
                  ...
                  <p className="text-[9px] md:text-[10px] font-semibold text-orange-700 uppercase">管理箇所 (Management Location)</p>
                </div>
              ...
              <div className="bg-green-50 rounded-lg p-1.5 md:p-2 border border-green-200">
                ...
                <p className="text-[10px] md:text-xs font-bold text-gray-900 leading-tight">{asset.name || "-"}</p>
              </div>
            ...
            <div className="flex flex-col gap-1.5 md:gap-2">
              ...
              <div className="bg-purple-50 rounded-lg p-1.5 md:p-2 border border-purple-200">
                ...
                <p className="text-[10px] md:text-xs text-gray-700 font-medium">{asset.user || "-"}</p>
              </div>
              ...
              <div className="bg-purple-50 rounded-lg p-1.5 md:p-2 border border-purple-200">
                ...
                <p className="text-[10px] md:text-xs text-gray-700 font-medium">{asset.actual_user || "-"}</p>
              </div>
              ...
              <div className="bg-cyan-50 rounded-lg p-1.5 md:p-2 border border-cyan-200">
                ...
                <div className="flex items-center gap-2">
                  {asset.lat && asset.lon ? (
                    <p className="text-[10px] md:text-xs text-gray-700">{asset.lat.toFixed(4)}, {asset.lon.toFixed(4)}</p>
                  ) : (
                    <p className="text-[10px] md:text-xs text-gray-700">-</p>
                  )}
                </div>
              </div>

              {/* 7. QR Code */}
              <div className="bg-gray-50 rounded-lg p-1.5 md:p-2 border border-gray-200">
                <div className="flex items-center gap-1 mb-0.5">
                  <Barcode className="w-3 h-3 text-gray-600" />
                  <p className="text-[9px] md:text-[10px] font-semibold text-gray-700 uppercase">QRコード (QR Code)</p>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 md:w-10 md:h-10 bg-white rounded border border-gray-300 flex items-center justify-center flex-shrink-0">
                    {asset.qr_code_url ? (
                      <img src={asset.qr_code_url} alt="QR" className="w-full h-full object-contain" />
                    ) : (
                      <Barcode className="w-4 h-4 md:w-5 md:h-5 text-gray-400" />
                    )}
                  </div>
                  <p className="text-[9px] md:text-[10px] text-gray-500 font-mono">{asset.qr_code || asset.id}</p>
                </div>
              </div>
              ...
              <div className="bg-yellow-50 rounded-lg p-1.5 md:p-2 border border-yellow-200">
                ...
                <div className="space-y-0.5 max-h-12 md:max-h-16 overflow-y-auto">
                  {(() => {
                    ...
                    if (!Array.isArray(history) || history.length === 0) {
                      return <p className="text-[10px] text-gray-500 italic">No changes recorded</p>;
                    }
