  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4 font-sans">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-2xl text-slate-700 font-medium">Inventory Management</p>
      </div>
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-15xl shadow-slate-500/50 border border-slate-400 overflow-hidden">
          <div className="p-8">
            <h2 className="text-3xl font-semibold text-slate-800 mb-6">Sign In</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-1.5">
                <label className="text-2xl font-semibold text-slate-700 ml-1">User ID</label>
              ...
              {/* Password */}
              <div className="space-y-1.5">
                <label className="text-2xl font-semibold text-slate-700 ml-1">Password</label>
                <div className="relative">
        ...
        <p className="mt-8 text-center text-slate-400 text-sm">
          &copy; 2025 SPring-8 Security Services. All rights reserved.
        </p>
      </div>
    </div>
  );
